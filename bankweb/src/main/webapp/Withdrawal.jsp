...
<%@ include file="navbar.jsp" %>
    ...
    <div class="container" >
        <div class="form-container">
            <div class="form-header">Apply Slot For Withdrawal </div>
            ...
            <form action="Withdrawalbooking" method="post">
                <div class="row">
                    <div class="col-md-6">
...
<tr>
  ...
  <th class="text-end">
    <a href="cancelSlotwithdrawal.jsp" class="btn cancel-btn"  id="cancel">Cancel Slot</a>
  </th>
</tr>
...
<a href="cancelSlotwithdrawal.jsp" class="btn btn-link text-danger">Cancel Slot</a></th></tr>-->
